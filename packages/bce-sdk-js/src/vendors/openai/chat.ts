...
export namespace Chat {
  ...
  export interface ChatCompletion {
    ...
    /**
     * The  type, which is always `chat.completion`.
     */
    object: string
  ...
  export type ChatCompletionCreateParams<Model> =
    | ChatCompletionCreateParamsNonStreaming<Model>
    | ChatCompletionCreateParamsStreaming<Model>

  export interface ChatCompletionCreateParamsBase<Model> {
    /**
  ...
  export interface ChatCompletionCreateParamsNonStreaming<Model> extends ChatCompletionCreateParamsBase<Model> {
    /**
     * If set, partial message deltas will be sent, like in ChatGPT. Tokens will be
     * sent as data-only
     * [server-sent events](https://developer.mozilla.org/en-US/docs/Web/API/Server-sent_events/Using_server-sent_events#Event_stream_format)
  ...
  export interface ChatCompletionCreateParamsStreaming<Model> extends ChatCompletionCreateParamsBase<Model> {
    /**
     * If set, partial message deltas will be sent, like in ChatGPT. Tokens will be
     * sent as data-only
     * [server-sent events](https://developer.mozilla.org/en-US/docs/Web/API/Server-sent_events/Using_server-sent_events#Event_stream_format)
